...
public class AuthController {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> exchangeCodeForToken(@RequestBody Map<String, String> request) {
        ...
        return webClient
                ...
                .header("Authorization", "Basic " + java.util.Base64.getEncoder().encodeToString("client-app:client-secret".getBytes()))
                .body(BodyInserters.fromFormData("grant_type", "authorization_code")
                        .with("code", code)
                        .with("redirect_uri", redirectUri))
                .retrieve()
                .bodyToMono(Map.class)
                .map(tokenResponse -> ResponseEntity.ok((Map<String, Object>) tokenResponse))
                .onErrorResume(error -> {
